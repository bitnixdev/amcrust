...
struct ResourceRequest {
    ...
    /// Secure-video snapshot reason: 0 = periodic, 1 = event.
    reason: Option<i64>,
}
...
struct Api {
    ...
    conn_shared_secret: std::sync::Arc<std::sync::RwLock<Option<[u8; 32]>>>,
    ...
    fn call(&mut self, req: Request<Body>) -> Self::Future {
        ...
        if method == Method::POST && uri.path() == "/resource" {
            ...
            return async move {
                ...
                let width = request.image_width.unwrap_or(1280);
                let height = request.image_height.unwrap_or(720);
        ...
        async move {
            ...
            loop {
                ...
                let api = Api::new(
                    ...
                    encrypted_stream.session_shared_secret.clone(),
                    secret_slot.clone(),
                    session_sender,
                );
